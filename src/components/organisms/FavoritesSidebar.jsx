...
const FavoritesSidebar = ({ 
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div className={cn(
        "hidden lg:block fixed right-6 top-20 bottom-6 w-80 z-30",
        className
      )}>
        <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-card border border-gray-200 h-full flex flex-col">
          {/* Header */}
